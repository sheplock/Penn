...
#cmt_local_tagfile_check_install_runtime = $(MC15JobOptions_tag)_check_install_runtime.make
...
#cmt_local_tagfile_check_install_runtime = $(MC15JobOptions_tag).make
...
#cmt_final_setup_check_install_runtime = $(bin)MC15JobOptions_check_install_runtimesetup.make
...
#cmt_final_setup_check_install_runtime = $(bin)MC15JobOptionssetup.make
cmt_local_check_install_runtime_makefile = $(bin)check_install_runtime.make
...
$(check_install_runtimeactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc48-opt/20.1.5/AtlasCore/20.1.5/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../share  ../gencontrol/*.dat  ../exocontrol/*.dat  ../susycontrol/*.dat  *.DEC ' -installdir=/home/shepj/InstallArea/share -level=warning
