...
#cmt_local_tagfile_check_install_joboptions = $(MC15JobOptions_tag)_check_install_joboptions.make
...
#cmt_local_tagfile_check_install_joboptions = $(MC15JobOptions_tag).make
...
#cmt_final_setup_check_install_joboptions = $(bin)MC15JobOptions_check_install_joboptionssetup.make
...
#cmt_final_setup_check_install_joboptions = $(bin)MC15JobOptionssetup.make
cmt_local_check_install_joboptions_makefile = $(bin)check_install_joboptions.make
...
$(check_install_joboptionsactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc48-opt/20.1.5/AtlasCore/20.1.5/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../share ../common/*.py ../common/MadGraph/*.py ../common/EvtGen/*.py ../common/EvtGen/*.pdt ../common/Herwigpp/*.py ../common/ParticleGun/*.py ../common/Pythia8/*.py ../common/Pythia/*.py ../common/Sherpa/*.py ../common/Filters/*.py ' -installdir=/home/shepj/InstallArea/jobOptions/MC15JobOptions -level=warning
