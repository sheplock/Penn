...
njets = 2
evgenLog.info('TEST:Registered generation of ~chi1+/- ~chi20 production, decay via WZ; grid point '+str(runArgs.runNumber)+' decoded into mass point ' + str(masses['1000024']) + ' ' + str(masses['1000022']))
...
evgenLog.info('CONFIG CHECK: '+str(runArgs.jobConfig[0]))
